...
"[project]/src/app/api/hls/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    ...
    try {
        ...
        if (!res.ok) {
            return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"](`Upstream error: ${res.status}`, {
                status: res.status
            });
        }
        ...
        if (contentType.includes("mpegurl") || url.includes(".m3u8")) {
            ...
            const rewritten = text.replace(/^(?!#)(.+\.(?:m3u8|ts).*)$/gm, (line)=>{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3a9f35b8._.js.map