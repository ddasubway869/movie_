...
;
;
const COOKIE_NAME = "slate_session";
...
function sessionCookieOptions(maxAge = COOKIE_MAX_AGE) {
    return {
        httpOnly: true,
...
const DB_PATH = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(DB_DIR, "slate.db");
function getDb() {
    ...
    const db = new __TURBOPACK__url__external__node$3a$sqlite__["DatabaseSync"](DB_PATH);
...
async function GET() {
    ...
    const db = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])();
    const user = db.prepare("SELECT id, username, email, (torbox_api_key IS NOT NULL) as has_api_key FROM users WHERE id = ?").get(session.userId);
    if (!user) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__396bcefa._.js.map